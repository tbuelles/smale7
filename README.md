...
## Overview
smale7 is an open-source Python package providing tools and models for scientific computing and geometric optimization on hyperspheres. This repo is motivated by numerical and algorithmic problems such as Smale's 7th problem, the (generalized) Thomson problem, the Tammes problem, spherical t-design, and quantum t-design.
...
- Generalized Thomson Problem: $E(x) = \sum_{i < j} \Vert x_i - x_j\Vert^{-s}$ with $s\in\mathbb{R}$. Goal: Find minimum energy $E_{min}$.<br>
